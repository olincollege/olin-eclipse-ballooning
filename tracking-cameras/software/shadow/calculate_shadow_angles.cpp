...
int main()
{
    ...
    Coordinates balloon_coordinates = {30.511833, -99.761336, 30000.0};

    pair<double, double> result = calc_angle_to_shadow(shadow_coordinates, balloon_coordinates);

    cout << "Time (UTC): " << hours << ":" << mins << ":" << seconds << endl;
    cout << "Latitude: " << shadowCoordinates.first << ", Longitude: " << shadowCoordinates.second << endl;
    cout << "Azimuth: " << result.first << ", Altitude: " << result.second << endl;
